...
import { loginGradient, logo, tree } from "../../../assets/images";
...
const Login = () => {
  ...
  // TODO: This is a temporary function to get the admin status of the user.
  // a more robust solution would be used depending on backend implementation
  const getAdminStatus = async () => {
    ...
    if (userId) {
      ...
      if (error) {
        ...
        localStorage.setItem("isAdmin", profile.is_admin);
      }
    }
  };
    ...
    >
      ...
      >
        ...
        <Box position="absolute" bottom={0} left={0}>
          <img src={tree} width="250px" style={{ objectFit: "cover" }} />
        </Box>
        <Box>
          <img
            src={loginGradient}
